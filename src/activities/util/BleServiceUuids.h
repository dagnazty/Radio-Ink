...
// AUTO-GENERATED by scripts/gen_ble_services.py from data/ble/service_uuids.csv.
// Bluetooth SIG assigned 16-bit GATT service UUIDs, sorted by uuid (binary search).
// Small enough (~75 entries) to stay in flash; do not edit by hand.

namespace ra {

struct BleServiceName {
  uint16_t uuid;
  const char* name;
};

inline constexpr BleServiceName BLE_SERVICE_NAMES[] = {
    {0x1800, "GAP"},
    {0x1801, "GATT"},
...
inline constexpr int BLE_SERVICE_NAME_COUNT =
    static_cast<int>(sizeof(BLE_SERVICE_NAMES) / sizeof(BLE_SERVICE_NAMES[0]));
