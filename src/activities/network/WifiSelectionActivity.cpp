...
void WifiSelectionActivity::onExit() {
  ...
  // (RadioInkWebServerActivity) manages WiFi connection state. We just clean
...
void WifiSelectionActivity::attemptConnection() {
  ...
  // Set hostname so routers show "RadioInk-Reader-AABBCCDDEEFF" instead of "esp32-XXXXXXXXXXXX"
  String mac = WiFi.macAddress();
  mac.replace(":", "");
  String hostname = "RadioInk-Reader-" + mac;
