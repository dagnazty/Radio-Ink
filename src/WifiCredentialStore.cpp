...
// File paths
constexpr char WIFI_FILE_BIN[] = "/.radioink/wifi.bin";
constexpr char WIFI_FILE_JSON[] = "/.radioink/wifi.json";
constexpr char WIFI_FILE_BAK[] = "/.radioink/wifi.bin.bak";

// Legacy obfuscation key - "RadioInk" in ASCII (only used for binary migration)
